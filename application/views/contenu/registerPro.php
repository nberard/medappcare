<form id="form-signup" class="form-signup" method="post" data-action="<?php echo site_url('membre');?>" >
    ...
    <input type="text" nom="pseudo" id="pseudo" class="input-block-level" placeholder="Pseudo (utilisé pour les commentaires)" required>
    <input type="email" id="reg_email" id="reg_email" class="input-block-level" placeholder="Email" required>
    <input type="password" id="reg_password" id="reg_password" class="input-block-level" placeholder="Mot de passe" required>
