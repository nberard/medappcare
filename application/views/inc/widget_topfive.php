<div id="listapps_topfive" class="listapps topfive" data-action="<?php echo site_url('application/topfiveapplis/'.$categorie->id);?>" data-render="<?php echo config_item('render_template_accept'); ?>" data-template="<?php echo $template_render; ?>">
